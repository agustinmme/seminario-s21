...
public class GestionCursosView extends JFrame {
    ...
    // Crea un panel de botones cursos
    ...
    private JPanel crearPanelTablas() {
        ...
        // Tabla de alumnos
        String[] columnasAlumnos = {"DNI", "Apellido", "Nombre", "Modulos Aprobados"};
        ...
        tablaAlumnos.setRowHeight(25); // TODO: PASA APPCONFIG
        ...
        tablaAlumnos.getColumnModel().getColumn(3).setPreferredWidth(100); // Estado
        ...
        // Panel de botones para alumnos
        JPanel panelBotonesAlumnos = inscribirAlumno();
    ...
    private JPanel inscribirAlumno() {
        JPanel panel = new JPanel(new FlowLayout(FlowLayout.LEFT, 10, 5));
    ...
    // Metods para habilitar/deshabilitar tablas
