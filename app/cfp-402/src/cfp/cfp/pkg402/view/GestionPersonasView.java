...
public class GestionPersonasView extends JFrame {
    ...
    // Cargar datos prueba - TODO: Pasar a modelo
    private void cargarDatosPrueba() {
        // Datos de personas
        modeloPersonas.addRow(new Object[]{"30123456", "Martinez", "Ana", "15/05/1990", "Alumno"});
        modeloPersonas.addRow(new Object[]{"31234567", "Garcia", "Luis", "22/07/1992", "Alumno"});
        modeloPersonas.addRow(new Object[]{"20987654", "Gonzalez", "Maria", "10/03/1980", "Profesor"});
        modeloPersonas.addRow(new Object[]{"25446789", "Rodriguez", "Carlos", "05/11/1985", "Profesor"});
        modeloPersonas.addRow(new Object[]{"18765432", "Fernandez", "Laura", "20/09/1975", "Profesor"});

        // Seleccionar por defecto algo
        if (tablaPersonas.getRowCount() > 0) {
            tablaPersonas.setRowSelectionInterval(2, 2);
            cargarDetallesPersona();
        }
    }

    // Cargar datos de la persona seleccionada
    public void cargarDetallesPersona() {
        int selectedRow = tablaPersonas.getSelectedRow();
        if (selectedRow >= 0) {
            txtDNI.setText(modeloPersonas.getValueAt(selectedRow, 0).toString());
            txtApellido.setText(modeloPersonas.getValueAt(selectedRow, 1).toString());
            txtNombre.setText(modeloPersonas.getValueAt(selectedRow, 2).toString());
            txtFechaNacimiento.setText(modeloPersonas.getValueAt(selectedRow, 3).toString());

            // Datos adicionales segun la persona seleccionada
            String dni = modeloPersonas.getValueAt(selectedRow, 0).toString();
            switch (dni) {
                case "30123456":
                    txtDireccion.setText("Av. Libertador 1234");
                    txtTelefono.setText("11-4455-6677");
                    txtEmail.setText("ana.martinez@email.com");
                    break;
                case "31234567":
                    txtDireccion.setText("Calle San Martin 567");
                    txtTelefono.setText("11-5566-7788");
                    txtEmail.setText("luis.garcia@email.com");
                    break;
                case "20987654":
                    txtDireccion.setText("Av. Corrientes 789");
                    txtTelefono.setText("11-4455-6677");
                    txtEmail.setText("maria.gonzalez@email.com");
                    break;
                case "25446789":
                    txtDireccion.setText("Belgrano 456");
                    txtTelefono.setText("11-7788-9900");
                    txtEmail.setText("carlos.rodriguez@email.com");
                    break;
                case "18765432":
                    txtDireccion.setText("Mitre 123");
                    txtTelefono.setText("11-3344-5566");
                    txtEmail.setText("laura.fernandez@email.com");
                    break;
            }

            String rol = modeloPersonas.getValueAt(selectedRow, 4).toString();
